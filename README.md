...
| **M53** ✅ | **The company chooses whom it follows** | each voice's posts against the 24h move after and before, peer-adjusted, by episode, with a sign test at a bar divided by the voices measured; a daily curation seat follows and drops from a closed set; `aurelis social voices` and `/voices` |
| **M54** ✅ | **Money is judged after costs** | paper round trips after fees, by independent episode, by sign test, with drawdown; earning at the family bar, losing at an undivided one; a losing scheme is suspended by Risk; the mandate reads `earning` |
